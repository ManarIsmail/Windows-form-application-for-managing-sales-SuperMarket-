...
SELECT id, Name, Code, Price, Quantity, Notes, Image, CategoryId FROM Product WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Product] SET [Name] = @Name, [Code] = @Code, [Price] = @Price, [Quantity] = @Quantity, [Notes] = @Notes, [Image] = @Image, [CategoryId] = @CategoryId WHERE (([id] = @Original_id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Code = 1 AND [Code] IS NULL) OR ([Code] = @Original_Code)) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)) AND ((@IsNull_Quantity = 1 AND [Quantity] IS NULL) OR ([Quantity] = @Original_Quantity)) AND ((@IsNull_CategoryId = 1 AND [CategoryId] IS NULL) OR ([CategoryId] = @Original_CategoryId)));
SELECT id, Name, Code, Price, Quantity, Notes, Image, CategoryId FROM Product WHERE (id = @id)";
        ...
        public virtual int Fill(POSTutDataSet3.ProductDataTable dataTable) {
        ...
        public virtual POSTutDataSet3.ProductDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            POSTutDataSet3.ProductDataTable dataTable = new POSTutDataSet3.ProductDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(POSTutDataSet3.ProductDataTable dataTable) {
        ...
        public virtual int Update(string Name, string Code, global::System.Nullable<decimal> Price, global::System.Nullable<int> Quantity, string Notes, string Image, global::System.Nullable<int> CategoryId, int Original_id, string Original_Name, string Original_Code, global::System.Nullable<decimal> Original_Price, global::System.Nullable<int> Original_Quantity, global::System.Nullable<int> Original_CategoryId, int id) {
            if ((Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Code, global::System.Nullable<decimal> Price, global::System.Nullable<int> Quantity, string Notes, string Image, global::System.Nullable<int> CategoryId, int Original_id, string Original_Name, string Original_Code, global::System.Nullable<decimal> Original_Price, global::System.Nullable<int> Original_Quantity, global::System.Nullable<int> Original_CategoryId) {
            return this.Update(Name, Code, Price, Quantity, Notes, Image, CategoryId, Original_id, Original_Name, Original_Code, Original_Price, Original_Quantity, Original_CategoryId, Original_id);
        }
    }
